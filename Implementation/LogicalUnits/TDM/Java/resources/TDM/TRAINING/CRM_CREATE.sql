...
--
-- TOC entry 2880 (class 2606 OID 16528)
-- Name: address address_pk; Type: CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
--
-- TOC entry 2884 (class 2606 OID 16530)
-- Name: cases case_pk; Type: CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
-- Name: contract contract_pk; Type: CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
--
-- TOC entry 2888 (class 2606 OID 16534)
-- Name: customer customer_pk; Type: CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
--
-- TOC entry 2882 (class 2606 OID 16536)
-- Name: case_note note_pk; Type: CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
-- Name: activity activity_fk1; Type: FK CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
--
-- TOC entry 2890 (class 2606 OID 16542)
-- Name: address address_fk1; Type: FK CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
--
-- TOC entry 2892 (class 2606 OID 16547)
-- Name: cases case_fk1; Type: FK CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
--
-- TOC entry 2891 (class 2606 OID 16552)
-- Name: case_note case_note_fk1; Type: FK CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
--
-- TOC entry 2893 (class 2606 OID 16557)
-- Name: contract contract_fk1; Type: FK CONSTRAINT; Schema: public; Owner: CRM_USER
--
...
-- Completed on 2022-12-08 17:42:53
