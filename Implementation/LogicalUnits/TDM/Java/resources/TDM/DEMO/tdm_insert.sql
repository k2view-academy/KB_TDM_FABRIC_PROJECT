...
-- Source Env
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (1, 1, 1, '1', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (2, 1, 2, 'PROD', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (3, 1, 3, '1', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (4, 1, 4, '1', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;

-- Target Env
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (5, 2, 1, '1', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (6, 2, 2, 'DEV', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (7, 2, 3, '1', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (8, 2, 4, '1', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;

--Synthetic Env
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (9, -1,  1, 'Synthetic', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (10, -1, 2, 'Synthetic', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (11, -1, 3, 'Synthetic', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
INSERT INTO public.environment_products (environment_product_id, environment_id, product_id, product_version, created_by, creation_date, last_updated_date, last_updated_by, status, data_center_name) VALUES (12, -1, 4, 'Synthetic', 'admin', now(), now(), 'admin', 'Active', 'LOCAL_DC') ON CONFLICT DO NOTHING;
