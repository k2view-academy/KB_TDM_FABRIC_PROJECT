...
insert into ${@schema}.tdm_general_parameters (param_name, param_value) values('TABLE_DEFAULT_DISTRIBUTION_MIN', 1);
insert into ${@schema}.tdm_general_parameters (param_name, param_value) values('TABLE_DEFAULT_DISTRIBUTION_MAX', 3);
