...
package com.k2view.cdbms.usercode.lu.CRM;
...
public class Globals extends SharedGlobals {
	...
	@category("TDM")
	public static String ROOT_TABLE_NAME = "FABRIC_TDM_ROOT";
	...
	@category("TDM")
	public static String ROOT_COLUMN_NAME = "tblCol_e8decb7400b7436299d5bcbb45e2c6b8";
