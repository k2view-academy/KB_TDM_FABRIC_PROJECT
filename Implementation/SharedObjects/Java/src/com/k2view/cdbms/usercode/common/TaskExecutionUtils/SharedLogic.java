...
public class SharedLogic {
	...
	public static Object fnResumeTaskExecution(Long task_execution_id) throws Exception {
        ...
        try {
            ...
            db(TDM).execute("UPDATE " + schema + ".task_ref_exe_stats set execution_status= 'resume', end_time=null where task_execution_id = ? and lower(execution_status) = 'stopped'", task_execution_id);
	...
	public static Map<String, Object> fnGetVersionsForLoad(String entitiesList, Long be_id, String source_env_name, String fromDate, String toDate, List<Map<String, Object>> lu_list, String target_env_name) throws Exception {
